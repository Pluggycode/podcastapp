...
import { Blob } from 'openai/_shims/index.mjs'
    ...
    const generatePodcast = async () => {
       ...
       try{
        ...
        toast({
            ...
            console.log('error to generate podcast',error);
            toast({
  ...
  return (
    <div>
        <div className="flex flex-col gap-2.5 ">
            ...
            <Textarea className='input-class font-light focus-visible:ring-offset-orange-1' placeholder='provide text to generate audio' rows={5}
            value={props.voicePrompt} onChange={(e) => props.setVoicePrompt(e.target.value)}
